                            ...
                            <div class="tshadow mb25 bozero">    
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('email'); ?> (Login Username)</label><small class="req"> *</small>
                                            ...
                                            <div class="row around10">
                                                ...
                                                <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">
                                                                    <?php echo $this->lang->line('work_shift'); ?>
                                                                </label>
                                                        
                                                                <select id="shift" name="shift" class="form-control">
                                                                    <option value="">Select Work Shift</option>
                                                        
                                                                    <?php foreach ($work_shift as $key => $value) { ?>
                                                                        <option value="<?php echo $key; ?>"
                                                                            <?php echo set_select('shift', $key); ?>>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="exampleInputEmail1">
                                                            <?php echo $this->lang->line('work_location'); ?>
                                                        </label>
