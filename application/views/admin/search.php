                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><i
                                        class="fa fa-list"></i> <?php echo $this->lang->line('student_lists'); ?></a></li>
                            <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false"><i
                                        class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('detailed_view'); ?></a>
                            </li>
                        </ul>
                                                ...
                                                <tr>
                                                    ...
                                                    if (!empty($student['dob'])) {
                                                        echo date(
                                                            ...
                                                            strtotime($this->customlib->dateyyyymmddTodateformat($student['dob']))
                                                        );
                                                    }
                                                    ?></td>
                                            ...
                                            <div class="slide-row">
                                                ...
                                                <div class="slide-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-6 col-md-6">
                                                            <b><?php echo $this->lang->line('local_identification_no'); ?> :
                                                                &nbsp;&nbsp;</b><?php echo $student['samagra_id'] ?><br>
                                                            <b><?php echo $this->lang->line('guardian_name'); ?>
                                                                :&nbsp;&nbsp;</b><?php echo $student['guardian_name'] ?><br>
