                ...
                <div class="row">
                    <?php if ($this->rbac->hasPrivilege('Monthly fees_collection_widget', 'can_view')) { ?>
                        <div class="col-md-<?php echo $widget ?> col-sm-6">
                            <div class="info-box" style="display: flex; align-items: center; background: #e3fcef; padding: 15px; border-radius: 10px;">
                                <a href="<?php echo site_url('studentfee') ?>" style="display: flex; align-items: center; text-decoration: none; width: 100%;">
                                    <span class="info-box-icon" style="background: #28a745; color: white; padding: 15px; border-radius: 50%; margin-right: 15px;display: flex; justify-content: center; align-items: center; ">
                                        <i class="fa fa-money"></i>
                                    </span>
                                    <div class=" info-box-content" style="color: #333;">
                                        <span style="font-weight: bold; font-size: 1.1rem;"> <?php echo $this->lang->line('monthly_fees_collection'); ?> </span>
                                        <span style="display: block; font-size: 2.3rem; font-weight: bold;"> <?php echo $currency_symbol . $month_collection; ?> </span>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <?php if ($this->rbac->hasPrivilege('monthly_expense_widget', 'can_view')) { ?>
                        <div class="col-md-<?php echo $widget ?> col-sm-6">
                            <div class="info-box" style="display: flex; align-items: center; background: #fde8e8; padding: 15px; border-radius: 10px;">
                                <a href="<?php echo site_url('admin/expense') ?>" style="display: flex; align-items: center; text-decoration: none; width: 100%;">
                                    <span class="info-box-icon" style="background: #dc3545; color: white; padding: 15px; border-radius: 50%; margin-right: 15px;display: flex; justify-content: center; align-items: center;"><i class="fa fa-credit-card"></i></span>
                                    <div class="info-box-content" style="color: #333;">
                                        <span style="font-weight: bold; font-size: 1.1rem;"> <?php echo $this->lang->line('monthly_expenses'); ?> </span>
                                        <span style="display: block; font-size: 3.8rem; font-weight: bold;"> <?php echo $currency_symbol . $month_expense; ?> </span>
                                    </div>
                                </a>
                            </div>
                        </div>
                    ...
                    <?php if ($this->rbac->hasPrivilege('student_count_widget', 'can_view')) { ?>
                        <div class="col-md-<?php echo $widget ?> col-sm-6">
                            <div class="info-box" style="display: flex; align-items: center; background: #e8f4fd; padding: 15px; border-radius: 10px;">
                                <a href="<?php echo site_url('student/search') ?>" style="display: flex; align-items: center; text-decoration: none; width: 100%;">
                                    <span class="info-box-icon" style="background: #17a2b8; color: white; padding: 15px; border-radius: 50%; margin-right: 15px;display: flex; justify-content: center; align-items: center;"><i class="fa fa-user"></i></span>
                                    <div class="info-box-content" style="color: #333;">
                                        <span style="font-weight: bold; font-size: 1.1rem;"> <?php echo $this->lang->line('student'); ?> </span>
                                        <span style="display: block; font-size: 3.8rem; font-weight: bold;"> <?php echo $total_students; ?> </span>
                                    </div>
                                </a>
                            </div>
                        </div>
